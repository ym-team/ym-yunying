...
!function ($) {
	...
	var Datetimepicker = function (element, options) {
        ...
        this.isLastDayByMonth = options.isLastDayByMonth ;
	...
	Datetimepicker.prototype = {
					...
					case 'span':
						if (!target.is('.disabled')) {
							...
							if (target.is('.month')) {
                                ...
                                if(this.isLastDayByMonth === true && this.viewSelect >= 3){
                                    day = this._getLastDayByMonth(year , month);
                                }else{
                                    day = this.viewDate.getUTCDate();
                                }
        ...
        _getLastDayByMonth:function(year, month){
	...
	var DPGlobal = {
		...
		parseDate:        function (date, format, language, type) {
			...
			var parts = date && date.match(this.nonpunctuation) && this.splitDate(date) || [],
		...
		splitDate: function(date) {
			...
			if (/^\d{8}$/.test(date)) {
				...
				return date.match(this.nonpunctuation);
			}
		},
