        ...
        <div class="dl_con">
            ...
            <ul>
                ...
                <li>
                    ...
                    <span>
                        <input style="width: 50%; height: 2.5rem; color: #666 !important;background:white !important;" class="hqyzm" type="text" placeholder="请输入图形验证码" name="captcha" id="captcha" maxlength="4">
                ...
                <li>
                    <i><img src="${configjscss }/images/zc-ico3.png"/></i>
                    <span>
                        <input name="smsCode" id="smsCode" style="width: 50%;" type="number" placeholder="验证码"/>
                        <a id="sendCode" class="hqyzm" href="javascript:void(0)" onclick="sendMsg()">获取验证码</a>
                    </span>
                </li>
            </ul>
            <div class="btn">
...
<script type="text/javascript">
    ...
    function next() {
        if (checkUserPhone() && checkSmsCode() && checkCaptcha()) {
            $("#formSub").submit();
        }
    }
</script>
